@echo off
title Instalador de USB Auto-Sync Service
...
:isAdmin
:: 2. Ya somos administrador. Ejecutamos el instalador ocultando la politica de restriccion.
echo [+] Ejecutando instalador de USB Auto-Sync Service con privilegios elevados...
cd /d "%~dp0"
